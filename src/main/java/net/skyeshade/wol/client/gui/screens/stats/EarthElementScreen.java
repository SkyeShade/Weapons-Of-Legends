...
@OnlyIn(Dist.CLIENT)
public class EarthElementScreen extends Screen {
   ...
   public void renderWindow(PoseStack pPoseStack, int pMouseX, int pMouseY, int pOffsetX, int pOffsetY) {
      ...
      this.font.draw(pPoseStack, "Earth", (float)(pOffsetX -1-27/2+ WINDOW_WIDTH/2), (float)(pOffsetY + 6), 16753920);
