...
public class StatsWidget extends GuiComponent {
   ...
   @Nullable
   private StatsWidget parent;
   private final List<StatsWidget> children = Lists.newArrayList();
   @Nullable
   private AdvancementProgress progress;
   private final int x;
   private final int y;

   public StatsWidget(StatsTab pTab, Minecraft pMinecraft, Advancement pAdvancement, DisplayInfo pDisplay) {
      this.tab = pTab;
   ...
   @Nullable
   private StatsWidget getFirstVisibleParent(Advancement pAdvancement) {
      do {
   ...
   public void drawConnectivity(PoseStack pPoseStack, int pX, int pY, boolean pDropShadow) {
      ...
      for(StatsWidget advancementwidget : this.children) {
   ...
   public void draw(PoseStack pPoseStack, int pX, int pY) {
      if (!this.display.isHidden() || this.progress != null && this.progress.isDone()) {
         ...
         StatsWidgetType advancementwidgettype;
         if (f >= 1.0F) {
            advancementwidgettype = StatsWidgetType.OBTAINED;
         } else {
            advancementwidgettype = StatsWidgetType.UNOBTAINED;
         }
   ...
   public void addChild(StatsWidget pAdvancementWidget) {
   ...
   public void drawHover(PoseStack pPoseStack, int pX, int pY, float pFade, int pWidth, int pHeight) {
      ...
      StatsWidgetType advancementwidgettype;
      StatsWidgetType advancementwidgettype1;
      StatsWidgetType advancementwidgettype2;
      if (f >= 1.0F) {
         j = this.width / 2;
         advancementwidgettype = StatsWidgetType.OBTAINED;
         advancementwidgettype1 = StatsWidgetType.OBTAINED;
         advancementwidgettype2 = StatsWidgetType.OBTAINED;
      } else if (j < 2) {
         j = this.width / 2;
         advancementwidgettype = StatsWidgetType.UNOBTAINED;
         advancementwidgettype1 = StatsWidgetType.UNOBTAINED;
         advancementwidgettype2 = StatsWidgetType.UNOBTAINED;
