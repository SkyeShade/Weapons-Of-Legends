...
@OnlyIn(Dist.CLIENT)
public class WindElementScreen extends Screen {
   ...
   public void renderWindow(PoseStack pPoseStack, int pMouseX, int pMouseY, int pOffsetX, int pOffsetY) {
      ...
      this.font.draw(pPoseStack, "Wind", (float)(pOffsetX -1-19/2+ WINDOW_WIDTH/2), (float)(pOffsetY + 6), 16753920);
